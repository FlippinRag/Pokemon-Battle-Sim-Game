...
{
    public class PlayerMessagePhase : IPhase
    {
        private readonly List<PlayerSprite> trainerSprites;
        private IDialogBoxQueuer dialogBoxQueuer;
        public bool IsDone { get; private set; }
        private bool playerMessageCompleted;


        public PlayerMessagePhase(List<PlayerSprite> trainerSprites)
        {
        ...
        public void LoadContent(IContentLoader contentLoader, IDialogBoxQueuer dialogBoxQueuer, BattleData battleData)
        {
            ...
            // dialogBoxQueuer.AppendBoxIntoQueue(new DialogBoxBattleMessage($"{battleData.Opponent.Name} would like to battle! {Environment.NewLine} {battleData.Opponent.Name} sent out {GlobalPokemon.EnemyInstance.EnemyPokemonName}!", new InputKeyboard()));
        ...
        public void Update(double gameTime)
        {
            ...
            playerMessageCompleted = IsDone; // Set the flag when the player message phase is done
